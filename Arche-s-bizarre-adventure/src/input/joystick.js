...
var Joystick = cc.Node.extend({
    ...
    _isSpeed2: false,   //是否开启二段速度
    _posInfo: {x:0, y:0},     //位置信息
    ...
    onTouchEnded: function(touch, event)
    {
        ...
        target.getParent()._isSpeed2 = false;
        target.getParent()._angle = 0;
    },
    ...
    update: function(dt)
    {
        ...
        {
            this.callback(this._posInfo, this._isSpeed2);
        }
    },
    ...
    _eightDirectionsMove: function()
    {
        ...
        else if(this._angle > 112.5 && this._angle < 157.5)
        {
            ...
            this._posInfo = { x: -1/1.414, y: 1/1.414};
        }
    ...
    {
        if(this._angle == 0){
            this._posInfo = {x:0,y:0};
            return;
        }
        this._posInfo = { x: Math.cos(this._angle * (Math.PI/180)), y: Math.sin(this._angle * (Math.PI/180))};
        //var info = this._posInfo;
        //this._target.x += info.x * this._speed;
        //this._target.y += info.y * this._speed;
    },
