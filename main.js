...
function resetDesignResolutionSize (designWidth,designHeight) {
...
errorLog = "";
function event_js_error( msg ){
    cc.log( "evnet_js_error:" + msg )
    if ( 0 >= errorLog.length )
        errorLog = "evnet_js_error:" + errorLog + msg + "\n";
    else
        errorLog = errorLog + "......" + msg + "\n";

    cc.director.runScene(new errorScene());
}
